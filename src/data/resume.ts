...
export const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        bullets: {
          ko: [
            // "직접 제안한 과제"가 문두 — 관형절("직접 제안해 구축한")로 쓰면 핵심 주장이
            // 수식어 자리에 묻히고 수식 범위도 모호해진다. 대시 뒤 전체가 그 과제의 내용.
            // 사실 근거: career-claims 4-1 자발 목록 4건째(본인 확인 2026-08-07).
            "직접 제안한 과제 — 계층형 Claude Code 설정(공통/FE/BE)·MCP 4종 통합, 업무일지·PR·문서 정리 스킬로 반복 작업 자동화",
