    ...
    <div className="flex h-full w-full flex-col justify-center gap-3">
      <div className="flex items-center gap-2">
        <div className="flex flex-col items-center rounded-md border border-accent/30 bg-white px-3 py-2 dark:bg-zinc-900">
          ...
          <span className="text-xs text-zinc-500 dark:text-zinc-400">Vue 3</span>
        </div>
        ...
        <div className="flex flex-1 flex-col items-center gap-0.5">
          ...
          <span className="font-mono text-xs text-zinc-500 dark:text-zinc-400">postMessage</span>
          <div className="flex w-full items-center">
            <span aria-hidden="true" className="text-[10px] text-accent">◀</span>
            <div className="h-0.5 flex-1 bg-accent/40" />
          </div>
          <span className="font-mono text-xs font-semibold text-accent">ACK</span>
        </div>

        <div className="flex flex-col items-center rounded-md border border-accent/30 bg-white px-3 py-2 dark:bg-zinc-900">
          <span className="text-sm font-bold text-zinc-800 dark:text-zinc-200">Display</span>
          <span className="text-xs text-zinc-500 dark:text-zinc-400">React</span>
        </div>
      </div>
